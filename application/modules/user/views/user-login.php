        ...
        <div class="row w-100">
          <div class="col-lg-4 mx-auto">
            <div class="auto-form-wrapper">
              <form action="<?=site_url('user/login_admin')?>" method="POST">
            ...
            <p class="footer-text text-center">copyright © 2018 Kemendesa. All rights reserved.</p>
          </div>
        </div>
      </div>
